...
int stewardEffect(int choice1, int choice2, int choice3, int handPos, int currentPlayer, struct gameState *state){
    if (choice1 == 1)
  	{
  	  //+2 cards
  	  drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return adventureCardEffect(drawntreasure, state, currentPlayer, cardDrawn, temphand, z);
    ...
    case steward:
      ...
      return stewardEffect(choice1, choice2, choice3, handPos, currentPlayer, state);
